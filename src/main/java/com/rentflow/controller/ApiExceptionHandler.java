...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ResponseEntity<ProblemResponse> handleNotFound(PricingNotFoundException exception, WebRequest request) {
        return response(
                HttpStatus.NOT_FOUND,
                "urn:rentflow:problem:pricing-not-found",
                "Pricing not found",
                "Pricing for serial number '" + exception.getSerialNumber() + "' was not found.",
                "PRICING_NOT_FOUND",
                request,
                List.of());
    }
    ...
    ResponseEntity<ProblemResponse> handleConflict(PricingAlreadyExistsException exception, WebRequest request) {
        return response(
                HttpStatus.CONFLICT,
